...
import us.eventlocations.androidtab.pager.HorizontalPager.OnScrollListener;
 ...
 * @version 0.1.0
 */
public final class HorizontalPager2 extends ViewGroup {
    /*
     ...
     */
    public HorizontalPager2(final Context context) {
        super(context);
        init();
    }
     ...
     */
    public HorizontalPager2(final Context context, final AttributeSet attrs) {
        super(context, attrs);
        init();
    }
