package us.eventlocations.androidtab.pager;
...
public class PagerControl extends View
{
    ...
    public PagerControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs,  R.styleable.us_eventlocations_androidtab_pager_PagerControl);
        int barColor = a.getColor(R.styleable.us_eventlocations_androidtab_pager_PagerControl_barColor, DEFAULT_BAR_COLOR);
        int highlightColor = a.getColor(R.styleable.us_eventlocations_androidtab_pager_PagerControl_highlightColor, DEFAULT_HIGHLIGHT_COLOR);
        fadeDelay = a.getInteger( R.styleable.us_eventlocations_androidtab_pager_PagerControl_fadeDelay, DEFAULT_FADE_DELAY);
        fadeDuration = a.getInteger( R.styleable.us_eventlocations_androidtab_pager_PagerControl_fadeDuration, DEFAULT_FADE_DURATION);
        ovalRadius = a.getDimension( R.styleable.us_eventlocations_androidtab_pager_PagerControl_roundRectRadius, 0f);
        a.recycle();
